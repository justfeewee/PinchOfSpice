...
public class PirateSkeletonModel extends EntityModel<PirateSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "pirate_skeleton"), "main");
	...
	public PirateSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(PirateSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
