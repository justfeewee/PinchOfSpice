...
public class ForgottenSkeletonModel extends EntityModel<ForgottenSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "forgotten_skeleton"), "main");
	...
	public ForgottenSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(ForgottenSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
