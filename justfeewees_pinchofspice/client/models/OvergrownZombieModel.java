...
public class OvergrownZombieModel extends EntityModel<OvergrownZombie> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "overgrown_zombie"), "main");
	...
	public OvergrownZombieModel(ModelPart root) {
	...
	@Override
	public void setupAnim(OvergrownZombie entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
