...
public class FrozenZombieMinerModel extends EntityModel<FrozenZombieMiner> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "frozen_zombie_miner"), "main");
	...
	public FrozenZombieMinerModel(ModelPart root) {
	...
	@Override
	public void setupAnim(FrozenZombieMiner entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
