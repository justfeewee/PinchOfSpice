...
public class TempleZombieModel extends EntityModel<TempleZombie> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "temple_zombie"), "main");
	...
	public TempleZombieModel(ModelPart root) {
	...
	@Override
	public void setupAnim(TempleZombie entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
