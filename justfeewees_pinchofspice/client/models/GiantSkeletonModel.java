...
public class GiantSkeletonModel extends EntityModel<GiantSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "giant_skeleton"), "main");
	...
	public GiantSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(GiantSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
