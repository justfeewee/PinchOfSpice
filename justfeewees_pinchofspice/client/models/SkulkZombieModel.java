...
public class SkulkZombieModel extends EntityModel<SkulkZombie> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "skulk_zombie"), "main");
	...
	public SkulkZombieModel(ModelPart root) {
	...
	@Override
	public void setupAnim(SkulkZombie entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
