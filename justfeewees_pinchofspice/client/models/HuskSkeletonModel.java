...
public class HuskSkeletonModel extends EntityModel<HuskSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "husk_skeleton"), "main");
	...
	public HuskSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(HuskSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
