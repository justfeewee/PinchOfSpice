...
public class BuriedSkeletonModel extends EntityModel<BuriedSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "buried_skeleton"), "main");
	...
	public BuriedSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(BuriedSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
