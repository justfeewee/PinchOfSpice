...
public class ZombieMinerModel extends EntityModel<ZombieMiner> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "zombie_miner"), "main");
	...
	public ZombieMinerModel(ModelPart root) {
	...
	@Override
	public void setupAnim(ZombieMiner entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
