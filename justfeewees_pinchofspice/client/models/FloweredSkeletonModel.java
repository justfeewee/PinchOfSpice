...
public class FloweredSkeletonModel extends EntityModel<FloweredSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "flowered_skeleton"), "main");
	...
	public FloweredSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(FloweredSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
