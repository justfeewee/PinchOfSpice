...
public class PossessedDummyModel extends EntityModel<PossessedDummy> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "possessed_dummy"), "main");
	...
	public PossessedDummyModel(ModelPart root) {
	...
	@Override
	public void setupAnim(PossessedDummy entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
