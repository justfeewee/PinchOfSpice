...
public class FishermanSkeletonModel extends EntityModel<FishermanSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "fisherman_skeleton"), "main");
	...
	public FishermanSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(FishermanSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
