...
public class CoralSkeletonModel extends EntityModel<CoralSkeleton> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PinchOfSpice.MODID, "coral_skeleton"), "main");
	...
	public CoralSkeletonModel(ModelPart root) {
	...
	@Override
	public void setupAnim(CoralSkeleton entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
