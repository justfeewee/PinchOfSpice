...
public class FrozenZombieMiner extends Monster {
    public FrozenZombieMiner(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getFrozenZombieMinerAttributes() {
