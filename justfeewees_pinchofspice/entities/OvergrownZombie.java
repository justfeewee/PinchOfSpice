...
public class OvergrownZombie extends Monster {
    public OvergrownZombie(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getOvergrownZombieAttributes() {
