...
public class FrozenZombie extends Monster {
    public FrozenZombie(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getFrozenZombieAttributes() {
