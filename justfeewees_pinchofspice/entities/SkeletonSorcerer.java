...
public class SkeletonSorcerer extends AbstractSkeleton {
    public SkeletonSorcerer(EntityType<? extends AbstractSkeleton> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getSkeletonSorcererAttributes() {
