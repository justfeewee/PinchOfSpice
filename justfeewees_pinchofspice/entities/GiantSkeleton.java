...
public class GiantSkeleton extends Monster {
    public GiantSkeleton(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getGiantSkeletonAttributes() {
