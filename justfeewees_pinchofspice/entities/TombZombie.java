...
public class TombZombie extends Monster {
    public TombZombie(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getTombZombieAttributes() {
