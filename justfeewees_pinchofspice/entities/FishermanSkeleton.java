...
public class FishermanSkeleton extends AbstractSkeleton {

    public FishermanSkeleton(EntityType<? extends AbstractSkeleton> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getFishermanSkeletonAttributes() {
