...
public class PossessedDummy extends Monster {
    public PossessedDummy(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getPossessedDummyAttributes() {
