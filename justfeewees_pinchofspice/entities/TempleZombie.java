...
public class TempleZombie extends Monster {
    public TempleZombie(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    ...
    public static AttributeSupplier.Builder getTempleZombieAttributes() {
